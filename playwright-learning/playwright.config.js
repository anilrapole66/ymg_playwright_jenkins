...
export default defineConfig({
   ...
   */
  webServer: {
    command: `cmd /c "cd ../ymgportal && set DJANGO_SETTINGS_MODULE=ymgportal/employee_portal.settings.py && ${PYTHON} manage.py migrate && ${PYTHON} manage.py runserver 127.0.0.1:8000"`,
