...
export default defineConfig({
   ...
   */
  webServer: {
  command: `cd .. && cd ymgportal && set DJANGO_SETTINGS_MODULE=ymgportal.settings_ci && ${PYTHON} ymgportal/manage.py migrate && ${PYTHON} ymgportal/manage.py runserver 127.0.0.1:8000`,
